...
"관리비", "세금", "온라인 쇼핑", "경조사", "기부", "교육", "의료", "유흥", "미용" , "통신비",
"급여", "로또"]

const card=[
{ name:"우리체크카드", bank:"woori"},
{name:"국민체크카드", bank:"kb"},
{name:"농협체크카드", bank:"nh"},
{name:"카카오체크카드", bank:"kakao"}];

const bank =[
{name:"우리은행", bank:'woori', money:1230000},
{name:"국민은행", bank:"kb", money:89000},
{name:"농협은행", bank:"nh", money:30000},
...
house.prototype.won=function(){ //돈을 천단위로 콤마를 찍어주고 그리고 나서 앞에 ￦이거 표시하기
  return "￦"+this.money.toLocaleString();
}
house.prototype.getWay=function(){ // 수입이든 지출이든 현금은 현금, 계좌와 카드는 어디에 있는지
