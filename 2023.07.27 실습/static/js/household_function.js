...
let isIncome=false; // 수입 이나 지출이냐 false면 지출 true면 수입
let way="";
...
function add(){
    ...
    var balance =account_update(parseInt(money));
...
// + 하기는 문자를 더하는 기능도 있기때문에 parseInt가 꼭 필요하다. 